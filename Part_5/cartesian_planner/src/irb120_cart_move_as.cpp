 ...
 { // constructor
    ...
    while (tferr) {
        ...
        try {
                ...
                ros::spinOnce();      
                ntries++;
                if (ntries>5) ROS_WARN("did you launch cartesian_planner/irb120_static_transforms.launch?");
            }   
    }
    ...
    //create an action client of robot's follow_joint_trajectory action server 
    ...
    */
    ...
    traj_publisher_ = nh_.advertise<trajectory_msgs::JointTrajectory>("joint_path_command", 1, true); 
