...
private:
    ...
    //arm_motion_interface::cart_moveGoal::ARM_TEST_MODE:
    ...
    actionlib::SimpleActionClient<arm_motion_interface::cart_moveAction> cart_move_action_client_; //("cartMoveActionServer", true);
