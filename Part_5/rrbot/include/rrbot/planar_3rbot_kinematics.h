...
//fwd kin fncs: tool flange w/rt base (link1)
    ...
    Eigen::Matrix4d get_flange_frame() {return A_mat_products_[NJNTS-1];}; //flange frame
...
public:
    ...
    int ik_solve(double dq1_sample_res, Eigen::Affine3d desired_flange_pose_wrt_base, std::vector<Eigen::Vector3d> &q_solns);
