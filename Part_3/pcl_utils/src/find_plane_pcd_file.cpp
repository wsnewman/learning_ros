...
//void find_indices_of_plane_from_patch(pcl::PCLPointCloud2::Ptr input_cloud_ptr,
//        pcl::PCLPointCloud2::Ptr patch_cloud_ptr, vector<int> &indices) {    
    float curvature;
    ...
    //pcl::PCLPointCloud2::Ptr transformed_cloud_ptr (new pcl::PCLPointCloud2 ()); 

    //cout << "fnc: selected patch size = " << patch_cloud_ptr->size() << endl;
