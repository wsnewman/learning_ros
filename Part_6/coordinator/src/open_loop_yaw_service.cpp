//open_loop_yaw_svc: same as open_loop_nav_svc, but for rotation
// exclusively to move + or - yaw rotation
...
using namespace std;
//speed params:
double MAX_SPEED=1.0; // set max speed param, rad/sec
double ACCEL=1.0; // rotational accel, rad/s^2
